    ...
    : QMainWindow(parent)
{
    ...
    //----------------------------------------------------
    //tableWidget_donnees_Integration->setEditTriggers(QAbstractItemView::NoEditTriggers); //pour empecher l'edition du tableau
    ...
    //-HAF 5-8-2020
    lineEdit_tolerance_eqtnonlineaire->setToolTip(tr("|f(x_i)|<=Tolérance"));
    //-HAF 19-8-2020
    ...
    if (locale!="fr")
    {
        label_image_AffectationEntrees_algo->setStyleSheet("QLabel{ image: url(:/icons/Affectation_Algo_En.png); }");
        label_image_AffectationEntrees_Orga->setStyleSheet("QLabel{ image: url(:/icons/Affectation_Organi_En.png); }");
        label_image_AffectationEntrees_ProgMatlab->setStyleSheet("QLabel{ image: url(:/icons/Affectation_ProgMatlab_En.png); }");
        label_image_AffectationEntrees_ProgCpp->setStyleSheet("QLabel{ image: url(:/icons/Affectation_ProgCpp_En.png); }");

        label_image_test_Algo->setStyleSheet("QLabel{ image: url(:/icons/Test_Algo_En.png); }");
        label_image_test_Orga->setStyleSheet("QLabel{ image: url(:/icons/test_Organi_En.png); }");
        label_image_test_Prog_Matlab->setStyleSheet("QLabel{ image: url(:/icons/test_ProgMatlab_En.png); }");
        label_image_test_Prog_Cpp->setStyleSheet("QLabel{ image: url(:/icons/test_ProgCpp_En.png); }");

        label_image_for_Algo->setStyleSheet("QLabel{ image: url(:/icons/Boucle_Algo_En.png); }");
        label_image_for_Orga->setStyleSheet("QLabel{ image: url(:/icons/Boucle_Organi_En.png); }");
        label_image_for_Prog_Matlab->setStyleSheet("QLabel{ image: url(:/icons/Boucle_ProgMatlab_En.png); }");
        label_image_for_Prog_Cpp->setStyleSheet("QLabel{ image: url(:/icons/Boucle_ProgCpp_En.png); }");

        label_image_while_Algo->setStyleSheet("QLabel{ image: url(:/icons/BoucleTest_Algo_En.png); }");
        label_image_while_Orga->setStyleSheet("QLabel{ image: url(:/icons/BoucleTest_Organi_En.png); }");
        label_image_while_prog_Matlab->setStyleSheet("QLabel{ image: url(:/icons/BoucleTest_ProgMatlab_En.png); }");
        label_image_while_prog_Cpp->setStyleSheet("QLabel{ image: url(:/icons/BoucleTest_ProgCpp_En.png); }");

        label_image_output_Algo->setStyleSheet("QLabel{ image: url(:/icons/Sorties_Algo_En.png); }");
        label_image_output_Orga->setStyleSheet("QLabel{ image: url(:/icons/Sorties_Organi_Eng.png); }");
        label_image_output_prog_Matlab->setStyleSheet("QLabel{ image: url(:/icons/Sorties_ProgMatlab_En.png); }");
        label_image_output_prog_Cpp->setStyleSheet("QLabel{ image: url(:/icons/Sorties_ProgCpp_En.png); }");
    }
    /////------HAF -17-4-2023--------
    pushButton_Copier_TableauSysNonLineaire->hide();
    connect(pushButton_Copier_TableauSysNonLineaire,SIGNAL(clicked()), this, SLOT(copy_tableWidget_donnees_Systeqtnonlineaire()));
    connect(buttonGroup_methodeSystEqtNonLineares,SIGNAL(idClicked(int)), this, SLOT(choixmethodeSystEqtNonLineares(int)));
    connect(pushButton_Calculer_methodesSystEqtLineaire, SIGNAL(clicked()), this, SLOT(hafresolutionSystEqtNonLineares()));
    connect(lineEdit_f1xy_Syst_non_lineaire, SIGNAL(textChanged(const QString)), this, SLOT(textChangedinfunctionf1xy()));
    connect(lineEdit_f2xy_Syst_non_lineaire, SIGNAL(textChanged(const QString)), this, SLOT(textChangedinfunctionf2xy()));

    connect(lineEdit_g1y_Syst_non_lineaire, SIGNAL(textChanged(const QString)), this, SLOT(textChangedinfunctiong1y()));
    connect(lineEdit_g2x_Syst_non_lineaire, SIGNAL(textChanged(const QString)), this, SLOT(textChangedinfunctiong2x()));

    connect(lineEdit_f1xyprime_sys_non_lineaire, SIGNAL(textChanged(const QString)), this, SLOT(textChangedinfunctionf1xyprime()));
    connect(lineEdit_f2xyprime_sys_non_lineaire, SIGNAL(textChanged(const QString)), this, SLOT(textChangedinfunctionf2xyprime()));

    connect(pushButton_Copier_Tableau_Integration,SIGNAL(clicked()), this, SLOT(copy_tableWidget_donnees_Integration()));
    pushButton_Copier_Tableau_Integration->hide();
    connect(buttonGroup_Integration,SIGNAL(idClicked(int)), this, SLOT(choixmethodeIntegration(int)));
    hafcolorBackground=QColor(0, 120, 0);
    hafcolorForeground=QColor(QColor("white"));

}
void basic_numerical_methods::on_commandLinkButton_SystNonLineaire_f1f2_clicked()
{
    QMessageBox msgBoxinfoNRcas2(this);
    msgBoxinfoNRcas2.setWindowTitle(tr("Info"));
    QString pubabout=tr("La permutation de f1(x,y) par f2(x,y) peut conduire à trouver une autre solution du système ou de rendre la méthode convergente!");
    msgBoxinfoNRcas2.setText(pubabout);
    msgBoxinfoNRcas2.exec();
}
void basic_numerical_methods::on_commandLinkButton_SystNonLineaire_g1g2_clicked()
{
    QMessageBox msgBoxinfoNRcas2(this);
    msgBoxinfoNRcas2.setWindowTitle(tr("Info"));
    QString pubabout=tr("Le changement de g1(x,y) ou/et g2(x,y) peut rendre la méthode convergente!");
    msgBoxinfoNRcas2.setText(pubabout);
    msgBoxinfoNRcas2.exec();
}
void basic_numerical_methods::on_commandLinkButton_SystNonLineaire_x0y0_clicked()
{
    QMessageBox msgBoxinfoNRcas2(this);
    msgBoxinfoNRcas2.setWindowTitle(tr("Info"));
    QString pubabout=tr("Le changement de x0 ou/et y0 peut conduire à trouver une autre solution du système ou de rendre la méthode convergente!");
    msgBoxinfoNRcas2.setText(pubabout);
    msgBoxinfoNRcas2.exec();
}
void basic_numerical_methods::choixmethodeIntegration(int)
{
    progressBar_Integration->setValue(0);
    pushButton_Copier_Tableau_Integration->hide();
}
void basic_numerical_methods::copy_tableWidget_donnees_Integration()
{
    QString resultatsfr0="";
    nbrecolumn_tableWidget_donnees_Integration=3;
    nbrerow_tableWidget_donnees_Integration=spinBox_nbre_pts_fx->text().toInt()-1;
    QString text[nbrerow_tableWidget_donnees_Integration+1][nbrecolumn_tableWidget_donnees_Integration];
    for (j=0; j<nbrecolumn_tableWidget_donnees_Integration ;j++)
    {
        resultatsfr0+=tableWidget_donnees_Integration->horizontalHeaderItem(j)->text()+"\t";
    }
    resultatsfr0+="\n";
    for (j=0; j<nbrecolumn_tableWidget_donnees_Integration ;j++)
    {
        for (i=0; i<=nbrerow_tableWidget_donnees_Integration ;i++)
        {
            text[i][j] =tableWidget_donnees_Integration->item(i,j)->text();
            if (j==nbrecolumn_tableWidget_donnees_Integration-1) {
               if (radioButton_trapezes->isChecked()) i=i+0;
               if (radioButton_simpson13->isChecked()) i=i+1;
               if (radioButton_simpson38->isChecked()) i=i+2;
            }
        }
    }
    for (i=0; i<=nbrerow_tableWidget_donnees_Integration ;i++)
...
void basic_numerical_methods::copy_tableWidget_donnees_Systeqtnonlineaire()
{
    QString resultatsfr0="";
    for (j=0; j<nbrecolumn_tableWidget_donnees_Sysnonlineaire ;j++)
    {
        resultatsfr0+=tableWidget_donnees_Sysnonlineaire->horizontalHeaderItem(j)->text()+"\t";
    }
    resultatsfr0+="\n";
    for (i=0; i<=nbrerow_tableWidget_donnees_Sysnonlineaire ;i++)
    {
        for (j=0; j<nbrecolumn_tableWidget_donnees_Sysnonlineaire ;j++)
        {
            resultatsfr0+=tableWidget_donnees_Sysnonlineaire->item(i,j)->text()+"\t";
        }
        resultatsfr0+="\n";
    }
    pressePapiers->setText(resultatsfr0);
}
void basic_numerical_methods::hafresolutionSysteqtnonlineaire_newtonraphson()
{
    progressBar_Sysnonlineaire->setValue(0);

    ndecimaux=spinBox_nbredecimaux_Systeqtnonlineaire->text().toInt();
    int nmax=spinBox_nmax_Systeqtnonlineaire->text().toInt();
    progressBar_Sysnonlineaire->setMaximum(nmax);
    i=0;
    double x[nmax];
    x[0]=lineEdit_x0_SysNonLineaire->text().toDouble();
    ...
    double y[nmax];
    y[0]=lineEdit_y0_SysNonLineaire->text().toDouble();
    if(x[0]==std::numeric_limits<double>::infinity() || x[0]==-std::numeric_limits<double>::infinity()){
        QMessageBox::critical(this, tr("Erreur"),
                              tr("La valeur de x0 dépasse les limites admissibles!"));
            return ;
    }
    double eps=lineEdit_tolerance_Systeqtnonlineaire->text().toDouble();
    while(true)
    {
        f1xy=lineEdit_f1xy_Syst_non_lineaire->text();
        int res = fparserf1xy.Parse(f1xy.toStdString(), "x,y");
        if(res < 0) break;
        if (strlen(fparserf1xy.ErrorMsg())!=0){
            QMessageBox errorMessage;
            errorMessage.setFixedSize(500, 200);
            errorMessage.critical(this, tr("Erreur dans f1(x,y)"),
    ...
    while(true)
    {
        f2xy=lineEdit_f2xy_Syst_non_lineaire->text();
        int res = fparserf2xy.Parse(f2xy.toStdString(), "x,y");
        if(res < 0) break;
        if (strlen(fparserf2xy.ErrorMsg())!=0){
            QMessageBox errorMessage;
            errorMessage.setFixedSize(500, 200);
            errorMessage.critical(this, tr("Erreur dans f2(x,y)"),
    ...
    while(true)
    {
        f1xyprime=lineEdit_f1xyprime_sys_non_lineaire->text();
        int res = fparserf1xyprime.Parse(f1xyprime.toStdString(), "x,y");
        if(res < 0) break;
        if (strlen(fparserf1xyprime.ErrorMsg())!=0){
            QMessageBox errorMessage;
            errorMessage.setFixedSize(500, 200);
            errorMessage.critical(this, tr("Erreur dans df1(x,y)/dx"),
                                  fparserf1xyprime.ErrorMsg());
            errorMessage.show();
            // break ;
            return ; // HAF 1-8-2020
        }
    ...
    while(true)
    {
        f2xyprime=lineEdit_f2xyprime_sys_non_lineaire->text();
        int res = fparserf2xyprime.Parse(f2xyprime.toStdString(), "x,y");
        if(res < 0) break;
        if (strlen(fparserf2xyprime.ErrorMsg())!=0){
            QMessageBox errorMessage;
            errorMessage.setFixedSize(500, 200);
            errorMessage.critical(this, tr("Erreur dans df2(x,y)/dx"),
                                  fparserf2xyprime.ErrorMsg());
            errorMessage.show();
            // break ;
            return ; // HAF 1-8-2020
        }
    ...
    ///////////////
    tableWidget_donnees_Sysnonlineaire->setRowCount(2);
    tableWidget_donnees_Sysnonlineaire->setColumnCount(5);
    nbrecolumn_tableWidget_donnees_Sysnonlineaire=5;
    tableWidget_donnees_Sysnonlineaire->clear();
    QStringList headtext={"i","x(i)","y(i)","f1(x(i),y(i))","f2(x(i),y(i))"};
    tableWidget_donnees_Sysnonlineaire->setStyleSheet("QTableView {selection-background-color: green;}");
    tableWidget_donnees_Sysnonlineaire->setHorizontalHeaderLabels(headtext);

    valsxy[0]=x[0];
    valsxy[1]=y[0];

    tableWidget_donnees_Sysnonlineaire->setItem(i,0,new QTableWidgetItem(QString::number(i)));
    tableWidget_donnees_Sysnonlineaire->setItem(i,1,new QTableWidgetItem(QString::number(x[i],'f',ndecimaux)));
    tableWidget_donnees_Sysnonlineaire->setItem(i,2,new QTableWidgetItem(QString::number(y[i],'f',ndecimaux)));
    tableWidget_donnees_Sysnonlineaire->setItem(i,3,new QTableWidgetItem(QString::number(fparserf1xy.Eval(valsxy),'f',ndecimaux)));
    tableWidget_donnees_Sysnonlineaire->setItem(i,4,new QTableWidgetItem(QString::number(fparserf2xy.Eval(valsxy),'f',ndecimaux)));
    ...
    {
        progressBar_Sysnonlineaire->setValue(i);
        ...
        tableWidget_donnees_Sysnonlineaire->setItem(i+1,0,new QTableWidgetItem(QString::number(i+1)));
        tableWidget_donnees_Sysnonlineaire->setItem(i+1,1,new QTableWidgetItem(QString::number(x[i+1],'f',ndecimaux)));
        tableWidget_donnees_Sysnonlineaire->setItem(i+1,2,new QTableWidgetItem(QString::number(y[i+1],'f',ndecimaux)));
        tableWidget_donnees_Sysnonlineaire->setItem(i+1,3,new QTableWidgetItem(QString::number(fparserf1xy.Eval(valsxy),'f',ndecimaux)));
        tableWidget_donnees_Sysnonlineaire->setItem(i+1,4,new QTableWidgetItem(QString::number(fparserf2xy.Eval(valsxy),'f',ndecimaux)));
        fparserf1xy_EvalError=fparserf1xy.EvalError();
        EvalErrorfunHAFxy(fparserf1xy_EvalError,"f1(x,y)",x[i], y[i],ndecimaux);
        fparserf2xy_EvalError=fparserf2xy.EvalError();
        EvalErrorfunHAFxy(fparserf2xy_EvalError,"f2(x,y)",x[i], y[i],ndecimaux);
        i=i+1;
        tableWidget_donnees_Sysnonlineaire->setRowCount(i+2);
        if(std::isnan(x[i]) ||
    ...
    tableWidget_donnees_Sysnonlineaire->resizeColumnsToContents();
    tableWidget_donnees_Sysnonlineaire->verticalHeader()->hide();
    progressBar_Sysnonlineaire->setValue(nmax);
    nbrerow_tableWidget_donnees_Sysnonlineaire=i;
    if(fparserf1xy_EvalError==0 && fparserf2xy_EvalError==0 && fparserf1xyprime_EvalError==0 && fparserf2xyprime_EvalError==0 && i<nmax && !std::isnan(x[i]) && !std::isnan(y[i]) && !std::isnan(fparserf1xy.Eval(valsxy))&& !std::isnan(fparserf2xy.Eval(valsxy)) && x[i]!=std::numeric_limits<double>::infinity() && x[i]!=-std::numeric_limits<double>::infinity()&& y[i]!=std::numeric_limits<double>::infinity() && y[i]!=-std::numeric_limits<double>::infinity()){
        /////tableWidget_donnees_Sysnonlineaire->setCurrentCell(i-1, 2);
        tableWidget_donnees_Sysnonlineaire->item(i,1)->setBackground(hafcolorBackground);
        tableWidget_donnees_Sysnonlineaire->item(i,2)->setBackground(hafcolorBackground);
        tableWidget_donnees_Sysnonlineaire->item(i,1)->setForeground(hafcolorForeground);
        tableWidget_donnees_Sysnonlineaire->item(i,2)->setForeground(hafcolorForeground);
        resultatsMessage.information(this, tr("Résultats"),tr("La méthode converge vers x=")+
                                     QString::number(x[i],'f',ndecimaux)+tr(" et vers y=")+
                                                                QString::number(y[i],'f',ndecimaux));
        pushButton_Copier_TableauSysNonLineaire->show();
    }else if(i>=nmax){
        resultatsMessage.warning(this, tr("Résultats"),
                                 tr("Le nombre maximal d'itérations a été atteint sans "
                                    ...
                                    "Peut-être que vous devez augmenter la tolérance ou le nombre maximal d'itérations\n"
                                    "Peut-être que vous devez changer x0 ou/et y0!\n"
                                    "Peut-être que vous devez permuter les fonctions f1(x,y) et f2(x,y)!\n"
                                    "Vérifier la condition de convergence de la méthode (Jacobienne)!"));
        ...
        resultatsMessage.warning(this, tr("Résultats"),
                                 tr("La méthode diverge  "
                                    ": Vérifier la condition de convergence de la méthode (Jacobienne) ou changer x0 ou/et y0!\n"
                                    "ou permuter les fonctions f1(x,y) et f2(x,y)!\n"));
    }
    tableWidget_donnees_Sysnonlineaire->scrollToBottom();
}
void basic_numerical_methods::textChangedinfunctionf1xyprime()
{
    f1xyprime=lineEdit_f1xyprime_sys_non_lineaire->text();
    fparserg1y.AddConstant("pi", M_PI);
    int res = fparserg1y.Parse(f1xyprime.toStdString(), "x,y");

    if(res > -1)
    {
        QPalette palette;
        palette.setColor(QPalette::Text,Qt::red);
        lineEdit_f1xyprime_sys_non_lineaire->setPalette(palette);
        validf1xyprime = false;
    }
    else
    {
        validf1xyprime = true;
        ...
        lineEdit_f1xyprime_sys_non_lineaire->setPalette(QApplication::style()->standardPalette());
    }
}
void basic_numerical_methods::textChangedinfunctionf2xyprime()
{
    f2xyprime=lineEdit_f2xyprime_sys_non_lineaire->text();
    fparserg2x.AddConstant("pi", M_PI);
    int res = fparserg2x.Parse(f2xyprime.toStdString(), "x,y");

    if(res > -1)
    {
        QPalette palette;
        palette.setColor(QPalette::Text,Qt::red);
        lineEdit_f2xyprime_sys_non_lineaire->setPalette(palette);
        validf2xyprime = false;
    }
    else
    {
        validf2xyprime = true;
        QPalette palette;
        palette.setColor(QPalette::Text,Qt::black);
        lineEdit_f2xyprime_sys_non_lineaire->setPalette(QApplication::style()->standardPalette());
    }
}
void basic_numerical_methods::textChangedinfunctionf1xy()
{
    f1xy=lineEdit_f1xy_Syst_non_lineaire->text();
    ...
    if(res > -1)
    {
        QPalette palette;
        palette.setColor(QPalette::Text,Qt::red);
        lineEdit_f1xy_Syst_non_lineaire->setPalette(palette);
        validf1xy = false;
    }
    else
    {
        ...
        QPalette palette;
        palette.setColor(QPalette::Text,Qt::black);
        lineEdit_f1xy_Syst_non_lineaire->setPalette(QApplication::style()->standardPalette());
    }
}
void basic_numerical_methods::textChangedinfunctionf2xy()
{
    f2xy=lineEdit_f2xy_Syst_non_lineaire->text();
    ...
    if(res > -1)
    {
        QPalette palette;
        palette.setColor(QPalette::Text,Qt::red);
        lineEdit_f2xy_Syst_non_lineaire->setPalette(palette);
        validf2xy = false;
    }
    else
    {
        ...
        QPalette palette;
        palette.setColor(QPalette::Text,Qt::black);
        lineEdit_f2xy_Syst_non_lineaire->setPalette(QApplication::style()->standardPalette());
    }
}
void basic_numerical_methods::textChangedinfunctiong1y()
{
    g1y=lineEdit_g1y_Syst_non_lineaire->text();
    fparserg1y.AddConstant("pi", M_PI);
    ...
    if(res > -1)
    {
        QPalette palette;
        palette.setColor(QPalette::Text,Qt::red);
        lineEdit_g1y_Syst_non_lineaire->setPalette(palette);
        validg1y = false;
    }
    else
    {
        ...
        QPalette palette;
        palette.setColor(QPalette::Text,Qt::black);
        lineEdit_g1y_Syst_non_lineaire->setPalette(QApplication::style()->standardPalette());
    }
}
void basic_numerical_methods::textChangedinfunctiong2x()
{
    g2x=lineEdit_g2x_Syst_non_lineaire->text();
    fparserg2x.AddConstant("pi", M_PI);
    ...
    if(res > -1)
    {
        QPalette palette;
        palette.setColor(QPalette::Text,Qt::red);
        lineEdit_g2x_Syst_non_lineaire->setPalette(palette);
        validg2x = false;
    }
    else
    {
        ...
        QPalette palette;
        palette.setColor(QPalette::Text,Qt::black);
        lineEdit_g2x_Syst_non_lineaire->setPalette(QApplication::style()->standardPalette());
    }
}
void basic_numerical_methods::hafresolutionSysteqtnonlineaire_ptfixe()
{
    progressBar_Sysnonlineaire->setValue(0);
    ...
    while(true)
    {
        ...
        if (strlen(fparserg1y.ErrorMsg())!=0){
            QMessageBox errorMessage;
            errorMessage.setFixedSize(500, 200);
            errorMessage.critical(this, tr("Erreur dans g1(x,y)"),
                                  fparserg1y.ErrorMsg());
            errorMessage.show();
            // break ;
            return ; // HAF 1-8-2020
    ...
    while(true)
    {
        ...
        if (strlen(fparserg2x.ErrorMsg())!=0){
            QMessageBox errorMessage;
            errorMessage.setFixedSize(500, 200);
            errorMessage.critical(this, tr("Erreur dans g2(x,y)"),
                                  fparserg2x.ErrorMsg());
            errorMessage.show();
            // break ;
            return ; // HAF 1-8-2020
    ...
    if(fparserf1xy_EvalError==0 && fparserf2xy_EvalError==0 && fparserg1y_EvalError==0 && fparserg2x_EvalError==0 && i<nmax && !std::isnan(x[i]) && !std::isnan(y[i]) && !std::isnan(fparserf1xy.Eval(valsxy))&& !std::isnan(fparserf2xy.Eval(valsxy)) && x[i]!=std::numeric_limits<double>::infinity() && x[i]!=-std::numeric_limits<double>::infinity()&& y[i]!=std::numeric_limits<double>::infinity() && y[i]!=-std::numeric_limits<double>::infinity()){
        /////tableWidget_donnees_Sysnonlineaire->setCurrentCell(i, 1);
        tableWidget_donnees_Sysnonlineaire->item(i,1)->setBackground(hafcolorBackground);
        tableWidget_donnees_Sysnonlineaire->item(i,2)->setBackground(hafcolorBackground);
        tableWidget_donnees_Sysnonlineaire->item(i,1)->setForeground(hafcolorForeground);
        tableWidget_donnees_Sysnonlineaire->item(i,2)->setForeground(hafcolorForeground);
        ...
        resultatsMessage.warning(this, tr("Résultats"),
                                 tr("Le nombre maximal d'itérations a été atteint sans "
                                    ...
                                    "g1(x,y) ou/et g2(x,y) ou/et x0 ou/et y0! (ou augmenter la tolérance ou le nombre maximal d'itérations)\n"
        ...
        resultatsMessage.warning(this, tr("Résultats"),
                                 tr("La méthode diverge  "
                                    ": Peut-être que vous devez changer g1(x,y) ou/et g2(x,y) ou/et x0 ou/et y0!"));
    }
    tableWidget_donnees_Sysnonlineaire->scrollToBottom();
}
void basic_numerical_methods::EvalErrorfunHAFxy(int fparser_EvalError, QString fx, double x,double y,int ndecimaux)
{
    QString message;
...
void basic_numerical_methods::hafresolutionSystEqtNonLineares()
{
    stackedWidget_SystnonlineairEqt->setCurrentIndex(1);
    ...
    tableWidget_donnees_Sysnonlineaire->clear();
    pushButton_Copier_TableauSysNonLineaire->hide();
    id=stackedWidget_methodeSysteqtnonlineaire->currentIndex();
    switch (id) {
    case 0:
        if (validx0 && validtolerance){
            hafresolutionSysteqtnonlineaire_ptfixe();
        }else{
            resultatsMessage.warning(this, tr("Résultats"),
    ...
    case 1:
        if (validx0 && validtolerance){
            hafresolutionSysteqtnonlineaire_newtonraphson();
        }else{
            resultatsMessage.warning(this, tr("Résultats"),
                                     tr("Données incorrectes! Vérifiez x0 ou/et Tolérance"));
        }
...
void basic_numerical_methods::choixmethodeSystEqtNonLineares(int id)
{
    stackedWidget_SystnonlineairEqt->setCurrentIndex(0);
    progressBar_Sysnonlineaire->setValue(0);
    tableWidget_donnees_Sysnonlineaire->clear();
    pushButton_Copier_TableauSysNonLineaire->hide();
    ...
    switch (id) {
    case -2:
        stackedWidget_gx_fprime_SysNonLineaire->setCurrentIndex(0);
        stackedWidget_methodeSysteqtnonlineaire->setCurrentIndex(0);
        break;

    case -3:
        stackedWidget_gx_fprime_SysNonLineaire->setCurrentIndex(1);
        stackedWidget_methodeSysteqtnonlineaire->setCurrentIndex(1);
        break;
    }
}
...
void basic_numerical_methods::hafcalculApproximationPolynomiale_Newton()
{
    ...
    tableWidget_donnees_ApproximationPolynomiale->item(0,1)->setBackground(hafcolorBackground);
    tableWidget_donnees_ApproximationPolynomiale->item(0,1)->setForeground(hafcolorForeground);
    tableWidget_donnees_ApproximationPolynomiale->resizeColumnsToContents();
}
...
void basic_numerical_methods::hafresolutionsysteqtlineaire_Jacobi()
{
    ...
    for (i = 0; i < n; i++) {
        tableWidget_Resultats_Gauss_Seidel->item(iter,i)->setBackground(hafcolorBackground);
        tableWidget_Resultats_Gauss_Seidel->item(iter,i)->setForeground(hafcolorForeground);
    }
    ...
    for(k=0;k<n-1;k++)for(i=k+1;i<=n-1;i++)
    {
        ...
        for(j=k;j<=n;j++){
            ...
            if (j<i) {
                ...
                tableWidget_matrice_triangulaire_sup->item(i,j)->setBackground(hafcolorBackground);
                tableWidget_matrice_triangulaire_sup->item(i,j)->setForeground(hafcolorForeground);
            }
        }
    }
...
void basic_numerical_methods::hafafficherIntegration()
{
    ...
    for (i=0; i<n ;i++)
    {
        if (radioButton_tableau_xy->isChecked())
        {
            QTableWidgetItem* item0 = tableWidget_donnees_Integration->item(i,0);
            QTableWidgetItem* item1 = tableWidget_donnees_Integration->item(i,1);
    ...
    if (radioButton_trapezes->isChecked())
    {
        if (radioButton_tableau_xy->isChecked())
        {
            for (i=0; i<n ;i++)
            {
                x[i]=tableWidget_donnees_Integration->item(i,0)->text().toDouble();
                y[i]=tableWidget_donnees_Integration->item(i,1)->text().toDouble();
            }
        }
        else if (radioButton_fx_a_b_dx->isChecked())
        {
            ...
            n=spinBox_nbre_pts_fx->text().toInt();
            dx=(b-a)/(n-1);
            tableWidget_donnees_Integration->setRowCount(m);
            spinBox_nbre_pts_tableau->setValue(n);
            tableWidget_donnees_Integration->clear();
            double vals[1];
            for(i=0; i<n; i++)
            {
                vals[0]=a+i*dx;
        ...
        if (radioButton_tableau_xy->isChecked())
        {
            ...
            tableWidget_donnees_Integration->setItem(0,2,new QTableWidgetItem(QString::number(0)));
            dx=x[1]-x[0];
            for (i=0; i<n-1; i++)
            {
                I=I+dx/2*(y[i]+y[i+1]);
                tableWidget_donnees_Integration->setItem(i+1,2,new QTableWidgetItem(QString::number(I)));
            }
        ...
        else if (radioButton_fx_a_b_dx->isChecked())
        {
            ...
            if(checkBox_remplir_tableau->isChecked())
            {
                ...
                tableWidget_donnees_Integration->setStyleSheet("QTableView {selection-background-color: green;}");
                tableWidget_donnees_Integration->setHorizontalHeaderLabels(headtext);
                for(i=0; i<n; i++)
                {
                    hafafficherprogressBaretape1(i,n);
                    tableWidget_donnees_Integration->setItem(i,0,new QTableWidgetItem(QString::number(x[i])));
                    tableWidget_donnees_Integration->setItem(i,1,new QTableWidgetItem(QString::number(y[i])));
                }
        ...
        tableWidget_donnees_Integration->resizeColumnsToContents();
    }
        ...
        if (okpoursimpson13==true)
        {
            ...
            if (radioButton_tableau_xy ->isChecked())
            {
                ...
                for (i=0; i<n-2; i+=2)
                {
                    ...
                    tableWidget_donnees_Integration->setItem(i+2,2,new QTableWidgetItem(QString::number(I)));
                    tableWidget_donnees_Integration->setItem(k+1,2,new QTableWidgetItem(""));
                    k+=2;
                }
                cherchernbrecolumntableau(n);
            }
        ...
        if (okpoursimpson38==true)
        {
            ...
            if (radioButton_tableau_xy ->isChecked())
            {
                ...
                for (i=0; i<n-3; i+=3)
                {
                    ...
                    tableWidget_donnees_Integration->setItem(i+3,2,new QTableWidgetItem(QString::number(I)));
                    tableWidget_donnees_Integration->setItem(k+1,2,new QTableWidgetItem(""));
                    tableWidget_donnees_Integration->setItem(k+2,2,new QTableWidgetItem(""));
                    k+=3;
                }
                cherchernbrecolumntableau(n);
            }
...
fin:;
    progressBar_Integration->setValue(100);
    tableWidget_donnees_Integration->horizontalHeader()->setStretchLastSection(true);
    tableWidget_donnees_Integration->resizeColumnsToContents();
    pushButton_Copier_Tableau_Integration->show();
}
void basic_numerical_methods::hafafficherprogressBaretape1(int i, int n)
{
    if (i>=n/10 && i<n/5)
    {
        progressBar_Integration->setValue(10);
    }
    if (i>=n/5 && i<n/4)
    {
        progressBar_Integration->setValue(15);
    }
    if (i>=n/4 && i<n/3)
    {
        progressBar_Integration->setValue(20);
    }
    if (i>=n/3 && i<n/2)
    {
        progressBar_Integration->setValue(25);
    }
    if (i>=n/2 && i<n/1.5)
    {
        progressBar_Integration->setValue(30);
    }
    if (i>=n/1.5 && i<=n)
    {
        progressBar_Integration->setValue(35);
    }
}
void basic_numerical_methods::hafafficherprogressBaretape2(int i, int n)
{
    if (i>=n/25 && i<n/15 )
    {
        progressBar_Integration->setValue(40);
    }
    if (i>=n/15 && i<n/10 )
    {
        progressBar_Integration->setValue(45);
    }
    if (i>=n/10 && i<n/8 )
    {
        progressBar_Integration->setValue(50);
    }
    if (i>=n/8 && i<n/5 )
    {
        progressBar_Integration->setValue(65);
    }
    if (i>=n/5 && i<n/3 )
    {
        progressBar_Integration->setValue(75);
    }
    if (i>=n/2 && i<n/1.75 )
    {
        progressBar_Integration->setValue(95);
    }
    if (i>=n/1.75 && i<=n )
    {
        progressBar_Integration->setValue(97);
    }
}
...
void basic_numerical_methods::remplirunelinevidetableau(int n)
{
    for (i=n; i<n+15 ;i++)
    {
        tableWidget_donnees_Integration->setItem(i,0,new QTableWidgetItem(""));
        tableWidget_donnees_Integration->setItem(i,1,new QTableWidgetItem(""));
    }
}
void basic_numerical_methods::cherchernbrecolumntableau(int n)
{
    ...
    for (i=n; i<m ;i++)
    {
        QTableWidgetItem* item = tableWidget_donnees_Integration->item(i,0);
...
fin7:;
    ...
    {
        tableWidget_donnees_Integration->setItem(i,2,new QTableWidgetItem(""));
    }
}
...
void basic_numerical_methods::about()
{
    ...
    QString pubabout=tr("Les programmes d'enseignement Informatique et Méthodes numériques 2022-2023 ; \n")+
